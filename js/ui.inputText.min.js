/* file: ui.inputText.js - v1.0.0 | minified on 2011/01/27 with http://jscompress.com/ */
(function($)
...
{var options=object.data('options'),properties=object.data('properties');for(var langValue in value)
